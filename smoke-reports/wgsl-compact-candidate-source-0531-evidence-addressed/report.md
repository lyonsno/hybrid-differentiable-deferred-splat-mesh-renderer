...
- Status: PASS
- Generated: 2026-05-31T23:42:28.987Z
...
- Decision requested: Verify compact source-index table repair preserves WGSL projected-ref stream evidence after review finding.
- Expected visual delta: none required; telemetry proof repair only
- Evidence surface: tests/renderer/gpuTileCoverageSkeleton.test.mjs compact source table witness plus pageEvidence.tileLocal.wgslProjectedRefStream.readback
...
- Average background delta: 17.67
- Distinct colors: 47741
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.21611762152777778
  },
  "findings": [
    {
...
```json
{
  ...
  "arenaRuntime": {
    ...
    "gpuDispatchEnqueueDurationMs": 0.1
  },
  "operatorWitness": {
  ...
  "tileLocal": {
    ...
    "wgslProjectedRefStream": {
      ...
      "sourceSplatCount": 94406,
      "maxTilesPerSplat": 9,
      "allocatedProjectedRefs": 724912,
      "tileCount": 3600,
      "maxRefsPerTile": 201,
      "dispatchEnqueueDurationMs": 0.1,
      "readback": {
        "status": "present",
        ...
        "sourceSplatCount": 94406,
        "maxTilesPerSplat": 9,
        "projectedScatterRefs": 788128,
        "retainedRefs": 127725,
        "droppedRefs": 660403,
        "projectedRefDelta": 63216,
        "nonEmptyTiles": 863,
        "saturatedTiles": 576,
        "maxRefsPerTile": 201,
        "headerRetainedRefs": 0,
        "headerProjectedRefs": 0,
        "headerCountClass": "headers-clear-only",
        "comparisonClass": "compact-candidate-footprint-divergence"
      }
    },
    "budgetDiagnostics": {
      "version": 1,
