...
- Status: PASS
- Generated: 2026-06-15T20:57:29.319Z
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 25682 / 921600 (2.787%)
- Average background delta: 2.35
- Distinct colors: 18480
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.02786675347222222
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | post-fx: fxaa+cas/2x/sharp 35% | app frame: 1.9ms | slowest app stage: gpu-sort-refresh 1ms",
  "title": "Deferred Splat+Mesh Renderer",
  "bodyText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | post-fx: fxaa+cas/2x/sharp 35% | app frame: 1.9ms | slowest app stage: gpu-sort-refresh 1ms\nPost FX",
  "canvas": {
    "width": 1280,
    "height": 720,
    "clientWidth": 1280,
