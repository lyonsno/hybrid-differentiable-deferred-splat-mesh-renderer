...
- Status: PASS
- Generated: 2026-06-15T20:36:24.415Z
...
- Expected visual delta: compute compositor output receives FXAA edge smoothing and CAS sharpening before canvas presentation
- Evidence surface: canvas screenshot and page evidence for renderer=compute post-process route
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 25407 / 921600 (2.757%)
- Average background delta: 2.35
- Distinct colors: 17709
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.027568359375
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 2.1ms | slowest app stage: gpu-sort-refresh 1.3ms",
  "title": "Deferred Splat+Mesh Renderer",
  "bodyText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 2.1ms | slowest app stage: gpu-sort-refresh 1.3ms",
  "canvas": {
    "width": 1280,
    "height": 720,
    "clientWidth": 1280,
