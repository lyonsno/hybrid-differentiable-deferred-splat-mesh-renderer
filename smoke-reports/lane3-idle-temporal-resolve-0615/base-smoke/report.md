...
- Status: PASS
- Generated: 2026-06-15T21:57:40.276Z
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 25721 / 921600 (2.791%)
- Average background delta: 2.34
- Distinct colors: 17681
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.027909071180555557
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 5 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | post-fx: fxaa+cas/8s/r2/sharp 35% | temporal: idle/8/8 | app frame: 0.3ms | slowest app stage: frame-uniforms 0ms | render: 12.04ms",
