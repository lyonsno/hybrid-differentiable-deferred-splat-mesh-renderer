...
- Status: PASS
- Generated: 2026-06-15T23:33:30.436Z
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | post-fx: fxaa+cas/8s/r2/sharp 35% | temporal: idle/8/8 | app frame: 0.4ms | slowest app stage: frame-uniforms 0ms | render: 12.94ms",
