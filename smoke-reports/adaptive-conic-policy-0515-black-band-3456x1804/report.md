...
- Status: PASS
- Generated: 2026-05-15T03:35:21.791Z
- URL: http://127.0.0.1:61736/?asset=/smoke-assets/scaniverse-first-smoke/scaniverse-first-smoke.json&witnessView=dessert-porous-close&tileSizePx=16&maxRefsPerTile=256&arenaBackend=gpu&renderer=tile-local-visible
...
- Nonblank: true
- Changed pixels: 464943 / 6234624 (7.457%)
- Average background delta: 6.92
- Distinct colors: 73827
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.07457434482015275
  },
  "findings": [
    {
...
```json
{
  ...
  "arenaRuntime": {
    ...
    "cpuBuildDurationMs": 26098.6,
    "gpuDispatchDurationMs": 0.1
  },
  "tileLocal": {
    "status": "current",
    "refs": 350464,
    ...
    "pixelContributorTrace": {
      ...
      "rendererMetadata": {
        ...
        "conicFalloffPolicy": "high-cap-gaussian-reference-tail"
      },
      "deferredFields": {
        "preserved": true,
        "deferredSurface": null,
