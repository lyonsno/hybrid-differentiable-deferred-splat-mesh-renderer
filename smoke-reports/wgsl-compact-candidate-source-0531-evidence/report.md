...
- Status: FAIL
- Generated: 2026-05-31T22:13:32.287Z
...
```json
{
  "consoleMessages": [
    ...
    {
      "type": "warning",
      "text": "The number of storage buffers (11) in the Compute stage exceeds the maximum per-stage limit (10).\n - While validating binding counts\n - While validating [BindGroupLayoutDescriptor \"\"gpu_tile_coverage_bind_group_layout\"\"]\n - While calling [Device].CreateBindGroupLayout([BindGroupLayoutDescriptor \"\"gpu_tile_coverage_bind_group_layout\"\"]).\n"
    },
    {
      "type": "warning",
      "text": "[Invalid BindGroupLayout \"gpu_tile_coverage_bind_group_layout\"] is invalid due to a previous error.\n - While calling [Device].CreatePipelineLayout([PipelineLayoutDescriptor \"\"gpu_tile_coverage_pipeline_layout\"\"]).\n"
    },
    {
      "type": "warning",
      "text": "[Invalid PipelineLayout \"gpu_tile_coverage_pipeline_layout\"] is invalid due to a previous error.\n - While calling [Device].CreateComputePipeline([ComputePipelineDescriptor \"\"gpu_tile_coverage_clear_tiles_pipeline\"\"]).\n"
    },
    {
      "type": "warning",
      "text": "[Invalid PipelineLayout \"gpu_tile_coverage_pipeline_layout\"] is invalid due to a previous error.\n - While calling [Device].CreateComputePipeline([ComputePipelineDescriptor \"\"gpu_tile_coverage_build_tile_refs_pipeline\"\"]).\n"
    },
    {
      "type": "warning",
      "text": "[Invalid PipelineLayout \"gpu_tile_coverage_pipeline_layout\"] is invalid due to a previous error.\n - While calling [Device].CreateComputePipeline([ComputePipelineDescriptor \"\"gpu_tile_coverage_composite_tiles_pipeline\"\"]).\n"
    },
    {
      "type": "warning",
      "text": "[Invalid BindGroupLayout \"gpu_tile_coverage_bind_group_layout\"] is invalid due to a previous error.\n - While validating [BindGroupDescriptor \"\"gpu_tile_coverage_bind_group\"\"] against [Invalid BindGroupLayout \"gpu_tile_coverage_bind_group_layout\"]\n - While calling [Device].CreateBindGroup([BindGroupDescriptor \"\"gpu_tile_coverage_bind_group\"\"]).\n"
    },
    {
      "type": "warning",
      "text": "[Invalid BindGroupLayout \"gpu_tile_coverage_bind_group_layout\"] is invalid due to a previous error.\n - While validating [BindGroupDescriptor \"\"gpu_tile_coverage_bind_group\"\"] against [Invalid BindGroupLayout \"gpu_tile_coverage_bind_group_layout\"]\n - While calling [Device].CreateBindGroup([BindGroupDescriptor \"\"gpu_tile_coverage_bind_group\"\"]).\n"
    ...
    {
      "type": "warning",
      "text": "[Invalid ComputePipeline \"gpu_tile_coverage_clear_tiles_pipeline\"] is invalid due to a previous error.\n - While encoding [ComputePassEncoder (unlabeled)].SetPipeline([Invalid ComputePipeline \"gpu_tile_coverage_clear_tiles_pipeline\"]).\n - While finishing [CommandEncoder (unlabeled)].\n"
    },
    {
      "type": "warning",
