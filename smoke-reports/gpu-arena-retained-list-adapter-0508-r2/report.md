...
- Status: PASS
- Generated: 2026-05-08T23:22:39.272Z
- URL: http://127.0.0.1:61619/?asset=/smoke-assets/scaniverse-first-smoke/scaniverse-first-smoke.json&renderer=tile-local-visible&arenaBackend=gpu
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 33445 / 921600 (3.629%)
- Average background delta: 3.30
- Distinct colors: 24781
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.036290147569444445
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: tile-local-visible-gaussian-compositor | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 94,406 splats/23 tiles | tile-local: 214x120 tiles/77221 refs | tile-order: gpu-sorted-index-rank-inversion | arena requested: gpu | arena effective: gpu | arena CPU build: 11623.000ms | arena GPU dispatch: 0.000ms",
