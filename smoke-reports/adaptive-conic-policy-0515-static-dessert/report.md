...
- Status: PASS
- Generated: 2026-05-15T03:28:46.486Z
- Base URL: http://127.0.0.1:53002/
...
- Tile-local changed pixels: 4.363%
- Tile-local/plate changed-pixel ratio: 1.2804916884274888 (max 2)
...
- URL: http://127.0.0.1:53002/?renderer=tile-local-visible
- Screenshot: `final-color.png`
- Renderer label: tile-local-visible-gaussian-compositor
- Tile refs: 77221
- Debug mode: final-color
- Nonblank: true
- Changed pixels: 40210 / 921600 (4.363%)

### Coverage weight heatmap

- URL: http://127.0.0.1:53002/?renderer=tile-local-visible&tileDebug=coverage-weight
- Screenshot: `coverage-weight.png`
- Renderer label: tile-local-visible-debug-coverage-weight
- Tile refs: 77221
- Debug mode: coverage-weight
- Nonblank: true
- Changed pixels: 45774 / 921600 (4.967%)

### Accumulated alpha heatmap

- URL: http://127.0.0.1:53002/?renderer=tile-local-visible&tileDebug=accumulated-alpha
- Screenshot: `accumulated-alpha.png`
- Renderer label: tile-local-visible-debug-accumulated-alpha
- Tile refs: 77221
- Debug mode: accumulated-alpha
- Nonblank: true
- Changed pixels: 46285 / 921600 (5.022%)

### Transmittance heatmap

- URL: http://127.0.0.1:53002/?renderer=tile-local-visible&tileDebug=transmittance
...
- URL: http://127.0.0.1:53002/?renderer=tile-local-visible&tileDebug=tile-ref-count
...
- URL: http://127.0.0.1:53002/?renderer=tile-local-visible&tileDebug=conic-shape
