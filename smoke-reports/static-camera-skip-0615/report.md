...
- Status: PASS
- Generated: 2026-06-15T17:50:09.666Z
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 25300 / 921600 (2.745%)
- Average background delta: 2.34
- Distinct colors: 17643
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.027452256944444444
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 1.8ms | slowest app stage: gpu-sort-refresh 1.1ms",
  "title": "Deferred Splat+Mesh Renderer",
  "bodyText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 1.8ms | slowest app stage: gpu-sort-refresh 1.1ms",
  "canvas": {
    "width": 1280,
    "height": 720,
    "clientWidth": 1280,
