...
- Status: PASS
- Generated: 2026-06-15T18:25:34.376Z
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 25306 / 921600 (2.746%)
- Average background delta: 2.79
- Distinct colors: 20221
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.027458767361111112
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 1.6ms | slowest app stage: gpu-sort-refresh 1.1ms",
  "title": "Deferred Splat+Mesh Renderer",
  "bodyText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 1.6ms | slowest app stage: gpu-sort-refresh 1.1ms",
  "canvas": {
    "width": 1280,
    "height": 720,
    "clientWidth": 1280,
