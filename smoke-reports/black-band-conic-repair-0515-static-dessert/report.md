...
- Status: FAIL
- Generated: 2026-05-15T03:16:02.976Z
- Base URL: http://127.0.0.1:51404/
...
- Tile-local changed pixels: 9.251%
- Tile-local/plate changed-pixel ratio: 2.715081841920897 (max 2)
...
- URL: http://127.0.0.1:51404/?renderer=tile-local-visible
- Screenshot: `final-color.png`
- Renderer label: tile-local-visible-gaussian-compositor
- Tile refs: 77221
- Debug mode: final-color
- Nonblank: true
- Changed pixels: 85259 / 921600 (9.251%)

### Coverage weight heatmap

- URL: http://127.0.0.1:51404/?renderer=tile-local-visible&tileDebug=coverage-weight
...
- URL: http://127.0.0.1:51404/?renderer=tile-local-visible&tileDebug=accumulated-alpha
...
- URL: http://127.0.0.1:51404/?renderer=tile-local-visible&tileDebug=transmittance
...
- URL: http://127.0.0.1:51404/?renderer=tile-local-visible&tileDebug=tile-ref-count
...
- URL: http://127.0.0.1:51404/?renderer=tile-local-visible&tileDebug=conic-shape
...
- tile-local-visible-footprint-expansion: Tile-local final color changed 2.72x as many pixels as plate on the fixed dessert witness.

## Summary

FAIL: Tile-local final color changed 2.72x as many pixels as plate on the fixed dessert witness.
