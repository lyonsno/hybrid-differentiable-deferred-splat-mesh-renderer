...
- Status: PASS
- Generated: 2026-06-15T20:05:36.643Z
- URL: http://127.0.0.1:52858/
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 23231 / 921600 (2.521%)
- Average background delta: 2.50
- Distinct colors: 19464
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.025207248263888888
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: plate | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 1.7ms | slowest app stage: gpu-sort-refresh 0.9ms",
  "title": "Deferred Splat+Mesh Renderer",
  "bodyText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: plate | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 1.7ms | slowest app stage: gpu-sort-refresh 0.9ms",
  "canvas": {
    "width": 1280,
    "height": 720,
    "clientWidth": 1280,
