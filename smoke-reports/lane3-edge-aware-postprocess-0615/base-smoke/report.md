...
- Status: PASS
- Generated: 2026-06-15T21:25:50.005Z
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 25706 / 921600 (2.789%)
- Average background delta: 2.33
- Distinct colors: 17801
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.027892795138888888
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | post-fx: fxaa+cas/8s/r2/sharp 35% | app frame: 2ms | slowest app stage: gpu-sort-refresh 1.1ms",
  "title": "Deferred Splat+Mesh Renderer",
  "bodyText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | post-fx: fxaa+cas/8s/r2/sharp 35% | app frame: 2ms | slowest app stage: gpu-sort-refresh 1.1ms\nPost FX",
  "canvas": {
    "width": 1280,
    "height": 720,
    "clientWidth": 1280,
