...
- Status: PASS
- Generated: 2026-06-15T20:47:02.121Z
- URL: http://127.0.0.1:5177/?renderer=compute
...
- Expected visual delta: compute post-process settings remain live-configurable while rendering real Scaniverse splats
- Evidence surface: canvas screenshot plus page evidence postProcess settings for renderer=compute controls slice
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 25736 / 921600 (2.793%)
- Average background delta: 2.34
- Distinct colors: 17762
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.027925347222222223
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | post-fx: fxaa+cas/2x/sharp 0.18 | app frame: 1.8ms | slowest app stage: gpu-sort-refresh 0.9ms",
  "title": "Deferred Splat+Mesh Renderer",
  "bodyText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | post-fx: fxaa+cas/2x/sharp 0.18 | app frame: 1.8ms | slowest app stage: gpu-sort-refresh 0.9ms\nPost FX",
  "canvas": {
    "width": 1280,
    "height": 720,
    "clientWidth": 1280,
