...
- Status: PASS
- Generated: 2026-06-15T17:47:40.967Z
...
- Canvas PNG: 1280x720
- Nonblank: true
- Changed pixels: 25301 / 921600 (2.745%)
- Average background delta: 2.33
- Distinct colors: 17661
...
```json
{
  ...
  "imageSummary": {
    "nonblank": true,
    "changedPixelRatio": 0.02745334201388889
  },
  "findings": [
    {
...
```json
{
  ...
  "statsText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 1.7ms | slowest app stage: gpu-sort-refresh 1.1ms",
  "title": "Deferred Splat+Mesh Renderer",
  "bodyText": "1280×720 | 0 fps | 94,406 real Scaniverse splats | renderer: compute | sort: gpu-bitonic-cpu-depth-keys | alpha: coverage-aware density 90,551 splats/13 tiles | arena requested: cpu | arena effective: cpu | app frame: 1.7ms | slowest app stage: gpu-sort-refresh 1.1ms",
  "canvas": {
    "width": 1280,
    "height": 720,
    "clientWidth": 1280,
