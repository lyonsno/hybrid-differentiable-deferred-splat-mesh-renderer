// Alpha-preserving present shader for overlay compositing.
// Outputs premultiplied alpha so the overlay canvas blends correctly
// over the host (e.g. Three.js) canvas via CSS compositing.
